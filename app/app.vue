        ...
        <ClientOnly>
            ...
            <main class="container mx-auto px-4 py-8">
                <UCard v-if="!imageStore.imagePreview" class="mb-8">
                    ...
                    <div
                        data-tutorial-id="upload-dropzone"
                                ...
                                >
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        ...
                                        <UButton
                                            ...
                                            size="sm"
                                            @click="
                                                colorStore.exportPalette('css')
                                            "
                                        >
                                            {{ $t("actions.export.css") }}
                                        </UButton>
                                        <UButton
                                            data-tutorial-id="copy-all"
                                            color="primary"
                                            variant="soft"
            ...
            <UFooter
                class="border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 mt-8"
            >
                <div
                    class="container mx-auto px-4 py-4 text-center text-sm text-gray-600 dark:text-gray-400"
                >
